      ...
      <article className="section-space bg-surface">
        <div className="mx-auto max-w-[800px] px-5">
          ...
          <div className="prose-measure mt-6 space-y-5 text-text-muted">
            <p>
              The first question on this page is the one the rest of the Coastal Towns / South
              Banks search results still fail to answer in one place: whether Coastal Towns is the
              same project as South Banks. It is. The remaining questions cover builders, address,
              home types, the conflicting price figures, launch timing, parks, transit, other
              Lakeview Village builders, schools, deposits, and how to register.
            </p>
            <p>
              ...
              the HTML on first load. Competing South Banks and Coastal Towns pages in this niche
            ...
            <p>
              ...
              has been verified or explicitly flagged. Where sources conflict — the $500,000s
