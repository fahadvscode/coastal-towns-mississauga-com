...
export const STATUS = "Coming this fall · registration open";
export const STATUS_SHORT = "Coming this fall";
export const LAUNCH = "Fall 2026 (coming this fall)";
export const COMPLETION = "2028";
export const UNIT_COUNT = "120+";
export const PRICE_RANGE_DISPLAY = "From $549,990";
export const PRICE_LOW = 549990;
export const PRICE_HIGH = 1000000;

export const SITE_NAME = "South Banks Towns";
...
export const OG_IMAGE = {
  ...
  width: 1200,
  height: 630,
  alt: "South Banks Towns — official townhome rendering in Lakeview Village, Mississauga.",
} as const;
...
export const HOME_ANSWER =
  "South Banks is a coastal townhome collection by Deco Homes and Opus Homes in Lakeview Village, Mississauga — on the shore of Lake Ontario at 1110 Lakeshore Road East. The official project site lists homes from $549,990, coming this fall. More than 120 three-storey freehold towns are planned, with private entrances and layered outdoor space.";

export const QUICK_FACTS: { label: string; value: string }[] = [
  { label: "Project", value: "South Banks Towns" },
  { label: "Builders", value: "Deco Homes & Opus Homes" },
  { label: "Type", value: "Coastal townhomes — 120+ three-storey freehold" },
  { label: "Address", value: "1110 Lakeshore Road East, Mississauga, ON" },
  { label: "Master plan", value: "Lakeview Village (177 acres, waterfront)" },
  { label: "Starting price (official site)", value: "From $549,990" },
  { label: "Launch", value: "Coming this fall (Fall 2026)" },
  { label: "Completion", value: "2028" },
  { label: "Sales gallery", value: "Coming soon" },
...
export const PRICING_ROWS: PricingRow[] = [
  {
    label: "Starting price on the official project site",
    value: "From $549,990",
    source: "southbanks.ca",
  },
  {
...
export const LAKEVIEW_COMPARISON: ComparisonRow[] = [
  {
    project: "South Banks Towns",
    builder: "Deco Homes & Opus Homes",
    notes:
      "120+ three-storey coastal townhomes at 1110 Lakeshore Road East. Official site lists from $549,990, coming this fall. 2028 completion reported.",
  },
  {
    project: "Aura Lakeview Village Towns",
    builder: "Caivan Communities",
    notes:
      "A separate townhome release inside the same 177-acre Lakeview Village master plan. Not a Deco/Opus project.",
  },
  {
...
export const FAQS: FaqItem[] = [
  {
    ...
    a: "South Banks is a coastal townhome collection by Deco Homes and Opus Homes at 1110 Lakeshore Road East in Mississauga's Lakeview Village. More than 120 three-storey freehold townhomes are planned, with private entrances and layered outdoor space, on the shore of Lake Ontario.",
  },
  {
  ...
  },
  {
    ...
    a: "The official South Banks site lists coastal townhomes from $549,990. Other listings still cite from the $500,000s, from the $700,000s, or a span up to about $1 million. Treat $549,990 as the current published starting figure and register for the confirmed collection sheet.",
  },
  {
  ...
  },
  {
    ...
    a: "The official project site places South Banks steps from the marina, the pier, and the park. Nearby public shoreline includes the Jim Tovey Lakeview Conservation Area (64 acres), Lakefront Promenade Park, and Marie Curtis Park. Lakeview Village is described as having over 50 acres of parks and greenspace, public promenades, retail, restaurants, and employment uses.",
  },
  {
  ...
  },
  {
    ...
    a: "Lakeview Village is a 177-acre master-planned waterfront redevelopment of the former Lakeview Generating Station site on Lake Ontario in Mississauga. The official South Banks site describes it as a major GTA waterfront project, minutes from downtown, with over 50 acres of parks and greenspace, public promenades, retail, restaurants, and employment opportunities.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Coastal Towns and Coastal Townhomes were earlier marketing names for this same Deco Homes and Opus Homes waterfront townhome project in Lakeview Village. It is now presented as South Banks, or South Banks Towns.",
  },
];

export const INDEPENDENCE_DISCLAIMER =
  "This is an independent information and registration website for South Banks Towns. It is not the official website of Deco Homes & Opus Homes and is not affiliated with or endorsed by the builder. All renderings, pricing, sizes, and specifications are for illustration only and are subject to change without notice. E.&O.E.";
